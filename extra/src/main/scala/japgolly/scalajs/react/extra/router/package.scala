...
package object router {
  ...
  type Router [P] = ReactComponentC.ConstProps[Unit, Resolution[P], _, TopNode]
  type RouterU[P] = ReactComponentU           [Unit, Resolution[P], _, TopNode]
  type RouterM[P] = ReactComponentM           [Unit, Resolution[P], _, TopNode]
